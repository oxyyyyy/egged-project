...
la("WeakMap",function(a){function b(k){this.f=(h+=Math.random()+1).toString();if(k){k=r(k);for(var l;!(l=k.next()).done;)l=l.value,this.set(l[0],l[1])}}
function c(){}
...
la("Set",function(a){function b(c){this.f=new Map;if(c){c=r(c);for(var d;!(d=c.next()).done;)this.add(d.value)}this.size=this.f.size}
...
var va=/^[\w+/_-]+[=]{0,2}$/,wa=null;function z(a,b){for(var c=a.split("."),d=b||w,e=0;e<c.length;e++)if(d=d[c[e]],null==d)return null;return d}
function xa(){}
...
D(E,Error);E.prototype.name="CustomError";var Ka=Array.prototype.indexOf?function(a,b){return Array.prototype.indexOf.call(a,b,void 0)}:function(a,b){if("string"===typeof a)return"string"!==typeof b||1!=b.length?-1:a.indexOf(b,0);
...
function Ua(a,b){var c=Ba(b),d=c?b:arguments;for(c=c?0:1;c<d.length;c++){if(null==a)return;a=a[d[c]]}return a}
...
function ab(a){var b=za(a);if("object"==b||"array"==b){if(A(a.clone))return a.clone();b="array"==b?[]:{};for(var c in a)b[c]=ab(a[c]);return b}return a}
...
m.set=function(a,b,c,d,e,f){if("object"===typeof c){var g=c.g;f=c.secure;e=c.domain;d=c.path;c=c.f}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===c&&(c=-1);e=e?";domain="+e:"";d=d?";path="+d:"";f=f?";secure":"";c=0>c?"":0==c?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(C()+1E3*c)).toUTCString();this.f.cookie=a+"="+b+e+d+c+f+(null!=g?";samesite="+g:"")};
...
function cc(a,b,c){var d=arguments,e=document,f=String(d[0]),g=d[1];if(!Xb&&g&&(g.name||g.type)){f=["<",f];g.name&&f.push(' name="',Lb(g.name),'"');if(g.type){f.push(' type="',Lb(g.type),'"');var h={};cb(h,g);delete h.type;g=h}f.push(">");f=f.join("")}f=dc(e,f);g&&("string"===typeof g?f.className=g:Aa(g)?f.className=g.join(" "):ac(f,g));2<d.length&&ec(e,f,d);return f}
function ec(a,b,c){function d(g){g&&b.appendChild("string"===typeof g?a.createTextNode(g):g)}
for(var e=2;e<c.length;e++){var f=c[e];!Ba(f)||Ca(f)&&0<f.nodeType?d(f):F(fc(f)?Qa(f):f,d)}}
function dc(a,b){b=String(b);"application/xhtml+xml"===a.contentType&&(b=b.toLowerCase());return a.createElement(b)}
function fc(a){if(a&&"number"==typeof a.length){if(Ca(a))return"function"==typeof a.item||"string"==typeof a.item;if(A(a))return"function"==typeof a.item}return!1}
...
function b(n){for(var v=g,q=0;64>q;q+=4)v[q/4]=n[q]<<24|n[q+1]<<16|n[q+2]<<8|n[q+3];for(q=16;80>q;q++)n=v[q-3]^v[q-8]^v[q-14]^v[q-16],v[q]=(n<<1|n>>>31)&4294967295;n=e[0];var y=e[1],V=e[2],ma=e[3],Bc=e[4];for(q=0;80>q;q++){if(40>q)if(20>q){var Ja=ma^y&(V^ma);var Gb=1518500249}else Ja=y^V^ma,Gb=1859775393;else 60>q?(Ja=y&V|ma&(y|V),Gb=2400959708):(Ja=y^V^ma,Gb=3395469782);Ja=((n<<5|n>>>27)&4294967295)+Ja+Bc+Gb+v[q]&4294967295;Bc=ma;ma=V;V=(y<<30|y>>>2)&4294967295;y=n;n=Ja}e[0]=e[0]+n&4294967295;e[1]=
e[1]+y&4294967295;e[2]=e[2]+V&4294967295;e[3]=e[3]+ma&4294967295;e[4]=e[4]+Bc&4294967295}
function c(n,v){if("string"===typeof n){n=unescape(encodeURIComponent(n));for(var q=[],y=0,V=n.length;y<V;++y)q.push(n.charCodeAt(y));n=q}v||(v=n.length);q=0;if(0==l)for(;q+64<v;)b(n.slice(q,q+64)),q+=64,p+=64;for(;q<v;)if(f[l++]=n[q++],p++,64==l)for(l=0,b(f);q+64<v;)b(n.slice(q,q+64)),q+=64,p+=64}
...
;function yc(a,b,c){var d=[],e=[];if(1==(Aa(c)?2:1))return e=[b,a],F(d,function(h){e.push(h)}),zc(e.join(" "));
...
var Fc;
function Gc(){var a=w.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&-1==Ab.indexOf("Presto")&&(a=function(){var e=dc(document,"IFRAME");e.style.display="none";e.src=lb(new ib(jb,gb())).toString();document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.write(Fb(Ib));e.close();var g="callImmediate"+Math.random(),h="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=B(function(k){if(("*"==h||
...
function bd(a){if(a instanceof ad)return a;if("function"==typeof a.D)return a.D(!1);if(Ba(a)){var b=0,c=new ad;c.next=function(){for(;;){if(b>=a.length)throw $c;if(b in a)return a[b++];b++}};
return c}throw Error("Not implemented");}
function cd(a,b){if(Ba(a))try{F(a,b,void 0)}catch(c){if(c!==$c)throw c;}else{a=bd(a);try{for(;;)b.call(void 0,a.next(),void 0,a)}catch(c){if(c!==$c)throw c;}}}
function dd(a){if(Ba(a))return Qa(a);a=bd(a);var b=[];cd(a,function(c){b.push(c)});
return b}
...
L.prototype.then=function(a,b,c){return ud(this,A(a)?a:null,A(b)?b:null,c)};
...
var Fd=Ec;function wd(a){E.call(this,a)}
D(wd,E);wd.prototype.name="cancel";function M(a){K.call(this);this.l=1;this.i=[];this.j=0;this.f=[];this.h={};this.o=!!a}
D(M,K);m=M.prototype;m.subscribe=function(a,b,c){var d=this.h[a];d||(d=this.h[a]=[]);var e=this.l;this.f[e]=a;this.f[e+1]=b;this.f[e+2]=c;this.l=e+3;d.push(e);return e};
...
D(Jd,Id);function Kd(a){this.data=a}
...
D(Md,Jd);Md.prototype.set=function(a,b,c){if(b=Ld(b)){if(c){if(c<C()){Md.prototype.remove.call(this,a);return}b.expiration=c}b.creation=C()}Md.L.set.call(this,a,b)};
Md.prototype.g=function(a){var b=Md.L.g.call(this,a);if(b){var c=b.creation,d=b.expiration;if(d&&d<C()||c&&c>C())Md.prototype.remove.call(this,a);else return b}};function Nd(){}
;function Od(){}
D(Od,Nd);Od.prototype.clear=function(){var a=dd(this.D(!0)),b=this;F(a,function(c){b.remove(c)})};function Pd(a){this.f=a}
D(Pd,Od);m=Pd.prototype;m.isAvailable=function(){if(!this.f)return!1;try{return this.f.setItem("__sak","1"),this.f.removeItem("__sak"),!0}catch(a){return!1}};
...
D(Qd,Pd);function Rd(a,b){this.g=a;this.f=null;if(Nb&&!(9<=Number(Ob))){Sd||(Sd=new ed);this.f=Sd.get(a);this.f||(b?this.f=document.getElementById(b):(this.f=document.createElement("userdata"),this.f.addBehavior("#default#userData"),document.body.appendChild(this.f)),Sd.set(a,this.f));try{this.f.load(this.g)}catch(c){this.f=null}}}
D(Rd,Od);var Td={".":".2E","!":".21","~":".7E","*":".2A","'":".27","(":".28",")":".29","%":"."},Sd=null;function Ud(a){return"_"+encodeURIComponent(a).replace(/[.!~*'()%]/g,function(b){return Td[b]})}
...
D(Wd,Od);Wd.prototype.set=function(a,b){this.g.set(this.f+a,b)};
...
;var $d=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};x("yt.config_",$d,void 0);function N(a){Zd($d,arguments)}
...
;function ie(a){var b=[];Ta(a,function(c,d){var e=encodeURIComponent(String(d)),f;Aa(c)?f=c:f=[c];F(f,function(g){""==g?b.push(e):b.push(e+"="+encodeURIComponent(String(g)))})});
return b.join("&")}
function je(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length)try{var f=decodeURIComponent((e[0]||"").replace(/\+/g," ")),g=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?Aa(b[f])?Ra(b[f],g):b[f]=[b[f],g]:b[f]=g}catch(k){if("q"!=e[0]){var h=Error("Error decoding URL component");h.params={key:e[0],value:e[1]};P(h)}}}return b}
...
;function me(a){var b=ne;a=void 0===a?z("yt.ads.biscotti.lastId_")||"":a;b=Object.assign(oe(b),pe(b));b.ca_type="image";a&&(b.bid=a);return b}
...
function pe(a){var b=a.f;try{var c=b.screenX;var d=b.screenY}catch(n){}try{var e=b.outerWidth;var f=b.outerHeight}catch(n){}try{var g=b.innerWidth;var h=b.innerHeight}catch(n){}b=[b.screenLeft,b.screenTop,c,d,b.screen?b.screen.availWidth:void 0,b.screen?b.screen.availTop:void 0,e,f,g,h];c=a.f.top;try{var k=(c||window).document,l="CSS1Compat"==k.compatMode?k.documentElement:k.body;var p=(new Zb(l.clientWidth,l.clientHeight)).round()}catch(n){p=new Zb(-12245933,-12245933)}k=p;p={};l=new Xd;w.SVGElement&&
w.document.createElementNS&&l.set(0);c=tc();c["allow-top-navigation-by-user-activation"]&&l.set(1);c["allow-popups-to-escape-sandbox"]&&l.set(2);w.crypto&&w.crypto.subtle&&l.set(3);w.TextDecoder&&w.TextEncoder&&l.set(4);l=Yd(l);p.bc=l;p.bih=k.height;p.biw=k.width;p.brdim=b.join();a=a.g;return p.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[a.visibilityState||a.webkitVisibilityState||a.mozVisibilityState||""]||0,p.wgl=!!H.WebGLRenderingContext,p}
var ne=new function(){var a=window.document;this.f=window;this.g=a};
x("yt.ads_.signals_.getAdSignalsString",function(a){return ie(me(a))},void 0);C();function Q(a){a=qe(a);return"string"===typeof a&&"false"===a?!1:!!a}
...
b.na&&0<b.timeout&&(f=R(function(){e||(e=!0,S(f),b.na.call(b.context||w))},b.timeout))}else Ee(a,b)}
function Ee(a,b){var c=b.format||"JSON";a=Ce(a,b);var d=De(a,b),e=!1,f,g=Fe(a,function(h){if(!e){e=!0;f&&S(f);var k=ue(h),l=null,p=400<=h.status&&500>h.status,n=500<=h.status&&600>h.status;if(k||p||n)l=Ge(c,h,b.nb);if(k)a:if(h&&204==h.status)k=!0;else{switch(c){case "XML":k=0==parseInt(l&&l.return_code,10);break a;case "RAW":k=!0;break a}k=!!l}l=l||{};p=b.context||w;k?b.onSuccess&&b.onSuccess.call(p,h,l):b.onError&&b.onError.call(p,h,l);b.ia&&b.ia.call(p,h,l)}},b.method,d,b.headers,b.responseType,
b.withCredentials);
...
c.src=a}
;function Qe(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(c instanceof Array?c:ba(r(c)))}
t(Qe,Error);var Re=new Set,Se=0;function Te(a,b,c,d,e,f){var g=z("yt.logging.errors.log");g?g(a,b,c,d,e,f):(g=O("ERRORS",[]),g.push([a,b,c,d,e,f]),N("ERRORS",g))}
...
window.console.log(f.join("\n"),a));f=a.f;b=a.columnNumber;if(a.args&&a.args.length)for(var g=0,h=0;h<a.args.length;h++){e=a.args[h];var k="params."+h;g+=k.length;if(e)if(Array.isArray(e))for(var l=c,p=0;p<e.length&&!(e[p]&&(g+=Ue(p,e[p],k,l),500<g));p++);else if("object"===typeof e)for(l in l=void 0,p=c,e){if(e[l]&&(g+=Ue(l,e[l],k,p),500<g))break}else c[k]=String(JSON.stringify(e)).substring(0,500),g+=c[k].length;else c[k]=String(JSON.stringify(e)).substring(0,500),g+=c[k].length;if(500<=g)break}else if(a.hasOwnProperty("params"))if(e=
a.params,"object"===typeof a.params)for(h in k=0,e){if(e[h]&&(g="params."+h,l=String(JSON.stringify(e[h])).substr(0,500),c[g]=l,k+=g.length+l.length,500<k))break}else c.params=String(JSON.stringify(e)).substr(0,500);a=Tb(a);(f=f||a.stack)||(f="Not available");h=a.lineNumber.toString();isNaN(h)||!b||isNaN(b)||(h=h+":"+b);window.yterr&&A(window.yterr)&&window.yterr(a);if(!(Re.has(a.message)||0<=f.indexOf("/YouTubeCenter.js")||0<=f.indexOf("/mytube.js"))){d={Xa:{a:"logerror",t:"jserror",type:a.name,
msg:a.message.substr(0,250),line:h,level:d,"client.name":c.name},C:{url:O("PAGE_NAME",window.location.href),file:a.fileName},method:"POST"};c.version&&(d["client.version"]=c.version);if(d.C){f&&(d.C.stack=f);f=r(Object.keys(c));for(b=f.next();!b.done;b=f.next())b=b.value,d.C["client."+b]=c[b];if(c=O("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(f=r(Object.keys(c)),b=f.next();!b.done;b=f.next())b=b.value,d.C[b]=c[b]}Ee(O("ECATCHER_REPORT_HOST","")+"/error_204",d);Re.add(a.message);Se++}}}
;var We=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};x("yt.msgs_",We,void 0);function Xe(a){Zd(We,arguments)}
...
;var bf=z("ytPubsubPubsubInstance")||new M;M.prototype.subscribe=M.prototype.subscribe;M.prototype.unsubscribeByKey=M.prototype.N;M.prototype.publish=M.prototype.M;M.prototype.clear=M.prototype.clear;x("ytPubsubPubsubInstance",bf,void 0);var cf=z("ytPubsubPubsubSubscribedKeys")||{};x("ytPubsubPubsubSubscribedKeys",cf,void 0);var df=z("ytPubsubPubsubTopicToKeys")||{};x("ytPubsubPubsubTopicToKeys",df,void 0);var ef=z("ytPubsubPubsubIsSynchronous")||{};x("ytPubsubPubsubIsSynchronous",ef,void 0);
...
function gf(){return z("ytPubsubPubsubInstance")}
...
;function yf(){}
t(yf,vf);function xf(a,b,c){isNaN(c)&&(c=void 0);var d=z("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):R(a,c||0)}
...
;var Of=0;x("ytDomDomGetNextId",z("ytDomDomGetNextId")||function(){return++Of},void 0);var Pf={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
Qf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Wa=z("ytEventsEventsListeners")||{};x("ytEventsEventsListeners",Wa,void 0);var Sf=z("ytEventsEventsCounter")||{count:0};x("ytEventsEventsCounter",Sf,void 0);
...
function Zf(a){var b=void 0===a?{}:a;a=void 0===b.Aa?!0:b.Aa;b=void 0===b.Ma?!1:b.Ma;if(null==z("_lact",window)){var c=parseInt(O("LACT"),10);c=isFinite(c)?C()-Math.max(c,0):-1;x("_lact",c,window);x("_fact",c,window);-1==c&&$f();U(document,"keydown",$f);U(document,"keyup",$f);U(document,"mousedown",$f);U(document,"mouseup",$f);a&&(b?U(window,"touchmove",function(){ag("touchmove",200)},{passive:!0}):(U(window,"resize",function(){ag("resize",200)}),U(window,"scroll",function(){ag("scroll",200)})));
...
function $f(){null==z("_lact",window)&&Zf();var a=C();x("_lact",a,window);-1==z("_fact",window)&&x("_fact",a,window);(a=z("ytglobal.ytUtilActivityCallback_"))&&a()}
function bg(){var a=z("_lact",window);return null==a?-1:Math.max(C()-a,0)}
;var cg=Math.pow(2,16)-1,dg=null,eg=0,fg={log_event:"events",log_interaction:"interactions"},gg=Object.create(null);gg.log_event="GENERIC_EVENT_LOGGING";gg.log_interaction="INTERACTION_LOGGING";var hg=new Set(["log_event"]),ig={},jg=0,kg=0,lg=0,W=z("ytLoggingTransportLogPayloadsQueue_")||{};x("ytLoggingTransportLogPayloadsQueue_",W,void 0);var mg=z("ytLoggingTransportTokensToCttTargetIds_")||{};x("ytLoggingTransportTokensToCttTargetIds_",mg,void 0);var ng=z("ytLoggingTransportDispatchedStats_")||{};
x("ytLoggingTransportDispatchedStats_",ng,void 0);x("ytytLoggingTransportCapturedTime_",z("ytLoggingTransportCapturedTime_")||{},void 0);function og(){S(jg);S(kg);kg=0;if(!Xa(W)){for(var a in W){var b=ig[a];b&&b.isReady()&&(pg(a,b),delete W[a])}Xa(W)||qg()}}
...
function pg(a,b){var c=fg[a],d=ng[a]||{};ng[a]=d;var e=Math.round(T());for(n in W[a]){var f=ab,g=b.f||sg();g={client:{hl:g.Ea,gl:g.Da,clientName:g.Ca,clientVersion:g.innertubeContextClientVersion,configInfo:g.Ba}};var h=window.devicePixelRatio;h&&1!=h&&(g.client.screenDensityFloat=String(h));h=O("EXPERIMENTS_TOKEN","");""!==h&&(g.client.experimentsToken=h);var k=h=void 0,l=[],p=O("EXPERIMENTS_FORCED_FLAGS",{});for(k in p)l.push({key:k,value:String(p[k])});k=O("EXPERIMENT_FLAGS",{});for(h in k)h.startsWith("force_")&&
void 0===p[h]&&l.push({key:h,value:String(k[h])});h=l;0<h.length&&(g.request={internalExperimentFlags:h});O("DELEGATED_SESSION_ID")&&!Q("pageid_as_header_web")&&(g.user={onBehalfOfUser:O("DELEGATED_SESSION_ID")});f=f({context:g});f[c]=rg(a,n);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(g=mg[n])a:{l=n;if(g.videoId)h="VIDEO";else if(g.playlistId)h="PLAYLIST";else break a;f.credentialTransferTokenTargetId=g;f.context=f.context||{};f.context.user=f.context.user||
{};f.context.user.credentialTransferTokens=[{token:l,scope:h}]}delete mg[n];f.requestTimeMs=e;Q("unsplit_gel_payloads_in_logs")&&(f.unsplitGelPayloadsInLogs=!0);if(g=O("EVENT_ID",void 0))h=(O("BATCH_CLIENT_COUNTER",void 0)||0)+1,h>cg&&(h=1),N("BATCH_CLIENT_COUNTER",h),g={serializedEventId:g,clientCounter:h},f.serializedClientEventId=g,dg&&eg&&Q("log_gel_rtt_web")&&(f.previousBatchInfo={serializedClientEventId:dg,roundtripMs:eg}),dg=g,eg=0;tg(b,a,f,{retry:hg.has(a),onSuccess:B(ug,this,T())})}if(d.previousDispatchMs){c=
...
;var vg=z("ytLoggingGelSequenceIdObj_")||{};x("ytLoggingGelSequenceIdObj_",vg,void 0);
...
Bg.prototype.toString=function(){return this.topic};var Cg=z("ytPubsub2Pubsub2Instance")||new M;M.prototype.subscribe=M.prototype.subscribe;M.prototype.unsubscribeByKey=M.prototype.N;M.prototype.publish=M.prototype.M;M.prototype.clear=M.prototype.clear;x("ytPubsub2Pubsub2Instance",Cg,void 0);var Dg=z("ytPubsub2Pubsub2SubscribedKeys")||{};x("ytPubsub2Pubsub2SubscribedKeys",Dg,void 0);var Eg=z("ytPubsub2Pubsub2TopicToKeys")||{};x("ytPubsub2Pubsub2TopicToKeys",Eg,void 0);var Fg=z("ytPubsub2Pubsub2IsAsync")||{};x("ytPubsub2Pubsub2IsAsync",Fg,void 0);
x("ytPubsub2Pubsub2SkipSubKey",null,void 0);function Gg(a,b){var c=Hg();c&&c.publish.call(c,a.toString(),a,b)}
function Ig(a){var b=Jg,c=Hg();if(!c)return 0;var d=c.subscribe(b.toString(),function(e,f){var g=z("ytPubsub2Pubsub2SkipSubKey");g&&g==d||(g=function(){if(Dg[d])try{if(f&&b instanceof Bg&&b!=e)try{var h=b.f,k=f;if(!k.args||!k.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!h.F){var l=new h;h.F=l.version}var p=h.F}catch(n){}if(!p||k.version!=p)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{f=Reflect.construct(h,
Qa(k.args))}catch(n){throw n.message="yt.pubsub2.Data.deserialize(): "+n.message,n;}}catch(n){throw n.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+n.message,n;}a.call(window,f)}catch(n){P(n)}},Fg[b.toString()]?z("yt.scheduler.instance")?wf(g):R(g,0):g())});
...
function Hg(){return z("ytPubsub2Pubsub2Instance")}
;function Ng(a){Ag.call(this,1,arguments);this.csn=a}
t(Ng,Ag);var Jg=new Bg("screen-created",Ng),Og=[],Pg=0;function Qg(a,b,c){var d=Rg;b={csn:a,parentVe:yg(b),childVes:Ma(c,function(f){return yg(f)})};
c=r(c);for(var e=c.next();!e.done;e=c.next())e=yg(e.value),(Xa(e)||!e.trackingParams&&!e.veType)&&Ve(Error("Child VE logged with no data"),"WARNING");c={ca:void 0,P:a};"UNDEFINED_CSN"==a?Sg("visualElementAttached",b,c):wg("visualElementAttached",b,d,c)}
function Sg(a,b,c){Og.push({La:a,payload:b,options:c});Pg||(Pg=Kg())}
function Lg(a){if(Og){for(var b=r(Og),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,wg(c.La,c.payload,null,c.options));Og.length=0}Pg=0}
...
function Ug(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||O("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.lb||O("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().kb:b=Ac([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=O("SESSION_INDEX",0),Q("pageid_as_header_web")&&(d["X-Goog-PageId"]=O("DELEGATED_SESSION_ID")));return d}
function Vg(a){a=Object.assign({},a);delete a.Authorization;var b=Ac();if(b){var c=new Rc;c.update(O("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();c=3;Ba(b);void 0===c&&(c=0);if(!Sb){Sb={};for(var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),e=["+/=","+/","-_=","-_.","-_"],f=0;5>f;f++){var g=d.concat(e[f].split(""));Rb[f]=g;for(var h=0;h<g.length;h++){var k=g[h];void 0===Sb[k]&&(Sb[k]=h)}}}c=Rb[c];d=[];for(e=0;e<b.length;e+=3){var l=b[e],p=(f=e+1<b.length)?
...
Xg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,C()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(id(b))}catch(f){return}else e=escape(b);Wg(a,e,c,this.g)};
...
timeout:d.timeout,withCredentials:!0},f="",g=a.f.Fa;g&&(f=g);g=a.f.Ga||!1;var h=Ug(g,f,d);Object.assign(e.headers,h);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=ke(""+f+("/youtubei/"+a.f.innertubeApiVersion+"/"+b),{alt:"json",key:a.f.innertubeApiKey}),l;if(d.retry&&Q("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=Zg(b,c,h,g))){var p=e.onSuccess,n=e.ma;e.onSuccess=function(v,q){$g(l);p(v,q)};
c.ma=function(v,q){$g(l);n(v,q)}}try{Q("use_fetch_for_op_xhr")?Be(k,e):(e.method="POST",e.C||(e.C={}),Ee(k,e))}catch(v){if("InvalidAccessError"==v)l&&($g(l),l=0),P(Error("An extension is blocking network request."),"WARNING");
else throw v;}l&&xf(function(){ah(a)},0,5E3)}
;var bh=C().toString();
function ch(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=C();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(bh)for(a=1,b=0;b<bh.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^bh.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var dh=z("ytLoggingTimeDocumentNonce_")||ch();x("ytLoggingTimeDocumentNonce_",dh,void 0);function eh(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function fh(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function gh(a){return O(fh(void 0===a?0:a),void 0)}
x("yt_logging_screen.getRootVeType",gh,void 0);function hh(){var a=gh(0),b;a?b=new xg({veType:a,youtubeData:void 0}):b=null;return b}
...
x("yt_logging_screen.getCurrentCsn",ih,void 0);function jh(a,b,c){c=void 0===c?0:c;if(a!==O(eh(c))||b!==O(fh(c)))N(eh(c),a),N(fh(c),b),0==c&&(b=function(){setTimeout(function(){a&&wg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:dh,clientScreenNonce:a},Rg)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())}
x("yt_logging_screen.setCurrentScreen",jh,void 0);function kh(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=O("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=O("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=I(J(3,window.location.href));g&&f.push(g);g=I(J(3,d));if(0<=Ka(f,g)||!g&&0==d.lastIndexOf("/",0))if(Q("autoescape_tempdata_url")&&(f=document.createElement("a"),Jb(f,d),d=f.href),d){g=d.match(jc);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||
b.ved)&&(b=Object.assign({csn:ih()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Mb(d).toString(36),e=e?lc(e):"",Wg(b,e,k||5))}else k=b,e="ST-"+Mb(d).toString(36),k=k?lc(k):"",Wg(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var p=void 0===p?"":p;var n=void 0===n?window:n;c=n.location;a=mc(a,l)+p;a=a instanceof G?a:zb(a);c.href=xb(a)}return!0}
...
t(mh,K);mh.prototype.m=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.mb)}K.prototype.m.call(this)};var nh=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function oh(a){a=a||"";if(window.spf){var b=a.match(nh);spf.style.load(a,b?b[1]:"",void 0)}else ph(a)}
...
t(sh,K);m=sh.prototype;m.getId=function(){return this.U};
...
function yh(a){var b=!0,c=zh(a);c&&a.f&&(a=Ah(a),b=$e(c,"version")==a);return b&&!!z("yt.player.Application.create")}
function vh(a){if(!a.g&&!a.K){var b=yh(a);if(b&&"html5"==(zh(a)?"html5":null))a.R="html5",a.w||Bh(a);else if(Ch(a),a.R="html5",b&&a.j)a.X.appendChild(a.j),Bh(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.B=function(){c=!0;var d=z("yt.player.Application.create"),e=a.f?a.f.clone():void 0;d(a.X,e,a.o);Bh(a)};
a.K=!0;b?a.B():(of(Ah(a),a.B),oh(a.o?a.o.cssUrl:a.f.assets.css),Dh(a)&&!c&&x("yt.player.Application.create",null,void 0))}}}
...
function wh(a,b){var c=b;if("string"==typeof b){if(a.Y[b])return a.Y[b];c=function(){var d=z(b);d&&d.apply(w,arguments)};
a.Y[b]=c}return c?c:null}
function Gh(a,b){var c="ytPlayer"+b+a.U;a.i[b]=c;w[c]=function(d){var e=R(function(){if(!a.g){a.H.M(b,d);var f=a.S,g=String(e);g in f&&delete f[g]}},0);
Ya(a.S,String(e))};
return c}
...
m.m=function(){Ch(this);if(this.j&&this.f&&this.j.destroy)try{this.j.destroy()}catch(b){P(b)}this.Y=null;for(var a in this.i)w[this.i[a]]=null;this.ba=this.f=this.api=null;delete this.X;delete this.l;K.prototype.m.call(this)};
...
t(Lh,Ag);function Mh(a,b){Ag.call(this,1,arguments)}
t(Mh,Ag);var Nh=new Bg("aft-recorded",Lh),Oh=new Bg("timing-sent",Mh);var Ph=!1;function Qh(){var a=Rh(void 0);if(a.aft)return a.aft;for(var b=O("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function Sh(a){var b;(b=z("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Ia("ytcsi."+(a||"")+"data_",b));return b}
function Th(){var a=Sh(void 0);a.info||(a.info={});return a.info}
function Rh(a){a=Sh(a);a.tick||(a.tick={});return a.tick}
function Uh(){var a=Sh(void 0).nonce;a||(a=ch(),Sh(void 0).nonce=a);return a}
function Vh(){var a=Rh(""),b=Qh();b&&!Ph&&(Gg(Nh,new Lh(Math.round(b-a._start),void 0)),Ph=!0)}
...
c=r(c);for(d=c.next();!d.done;d=c.next())Yh(a,d.value);return a}
...
function $h(a,b){for(var c=r(b),d=c.next();!d.done;d=c.next())d=d.value,Xh(d)?a.push(Yh({},d)):Zh(d)?a.push($h([],d)):a.push(d);return a}
function Xh(a){return"object"===typeof a&&!Array.isArray(a)}
function Zh(a){return"object"===typeof a&&Array.isArray(a)}
;function ai(){var a=z("ytcsi.debug");a||(a=[],x("ytcsi.debug",a,void 0),x("ytcsi.reference",{},void 0));return a}
function bi(){var a=z("ytcsi.reference");a||(ai(),a=z("ytcsi.reference"));if(a[""])return a[""];var b={timerName:"",info:{},tick:{}};ai().push(b);return a[""]=b}
;function ci(a,b,c){c=void 0===c?{}:c;var d=Rg;O("ytLoggingEventsDefaultDisabled",!1)&&Rg==Rg&&(d=null);wg(a,b,d,c)}
;var di=z("ytLoggingLatencyUsageStats_")||{};x("ytLoggingLatencyUsageStats_",di,void 0);function ei(){this.f=0}
function fi(){ei.f||(ei.f=new ei);return ei.f}
ei.prototype.tick=function(a,b,c){gi(this,"tick_"+a+"_"+b)||ci("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
ei.prototype.info=function(a,b){var c=Object.keys(a).join("");gi(this,"info_"+c+"_"+b)||(a.clientActionNonce=b,ci("latencyActionInfo",a))};
function gi(a,b){di[b]=di[b]||{count:0};var c=di[b];c.count++;c.time=T();a.f||(a.f=xf(a.g,0,5E3));return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new Qe("CSI data exceeded logging limit with key"),c.params={key:b},0===b.indexOf("info")?Te(c,"WARNING",void 0,void 0,void 0,void 0):Te(c)),!0):!1}
ei.prototype.g=function(){var a=T(),b;for(b in di)di[b]&&6E4<a-di[b].time&&delete di[b];this&&(this.f=0)};var Y={},hi=(Y.ad_allowed="adTypesAllowed",Y.yt_abt="adBreakType",Y.ad_cpn="adClientPlaybackNonce",Y.ad_docid="adVideoId",Y.yt_ad_an="adNetworks",Y.ad_at="adType",Y.browse_id="browseId",Y.p="httpProtocol",Y.t="transportProtocol",Y.cpn="clientPlaybackNonce",Y.cseg="creatorInfo.creatorSegment",Y.csn="clientScreenNonce",Y.docid="videoId",Y.GetHome_rid="getHomeRequestId",Y.GetSearch_rid="getSearchRequestId",Y.GetPlayer_rid="getPlayerRequestId",Y.GetWatchNext_rid="getWatchNextRequestId",Y.GetBrowse_rid=
...
ji={},ki=(ji.mver="MEASUREMENT_VERSION_",ji.pis="PLAYER_INITIALIZED_STATE_",ji.yt_pt="LATENCY_PLAYER_",ji.pa="LATENCY_ACTION_",ji.yt_vst="VIDEO_STREAM_TYPE_",ji),li="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetBrowse_rid GetHistory_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function mi(){return!!O("FORCE_CSI_ON_GEL",!1)||Q("csi_on_gel")||!!Sh(void 0).useGel}
function ni(){var a=Sh(void 0);if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;B(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||xa,X);function oi(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
...
function qi(a,b,c){if(Ca(a)){b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function ri(a,b,c,d){if(Ca(a)&&!Aa(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
;function si(a){a=void 0===a?!1:a;K.call(this);this.f=new M(a);Tc(this,Ha(Uc,this.f))}
D(si,K);si.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
...
t(ti,si);function ui(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(id(a),d.i))}}
...
m.m=function(){var a=this.f;a.g||Gd(a.f,"command",this.qa,this);this.f=null;for(var b in this.h)wi(this,b);K.prototype.m.call(this)};function zi(a,b){vi.call(this,b);this.i=a;this.start()}
...
Ai.prototype.m=function(){window.removeEventListener("message",this.o);K.prototype.m.call(this)};function Bi(){var a=this.g=new Ai(!!O("WIDGET_ID_ENFORCE")),b=B(this.Na,this);a.j=b;a.l=null;this.g.channel="widget";if(a=O("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
...
m.la=function(){};
function Ci(a,b){return B(function(c){this.sendMessage(b,c)},a)}
...
m.Ua=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:C()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());Di(this,a)};
m.Wa=function(){var a={sphericalProperties:this.f.getSphericalProperties()};Di(this,a)};
m.dispose=function(){Bi.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function Fi(a,b,c){K.call(this);this.f=a;this.i=c;this.j=U(window,"message",B(this.l,this));this.h=new ti(this,a,b);Tc(this,Ha(Uc,this.h))}
...
Fi.prototype.m=function(){Vf(this.j);this.f=null;K.prototype.m.call(this)};function Gi(){var a=$a(Hi),b;return vd(new L(function(c,d){a.onSuccess=function(e){ue(e)?c(e):d(new Ii("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
return td(c)})}
function Ii(a,b){E.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
t(Ii,E);function Ji(){this.g=0;this.f=null}
Ji.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),od(a)?a:Ki(a)):2===this.g&&b?(a=b.call(c,this.f),od(a)?a:Li(a)):this};
...
;function Mi(a){E.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Ni;this.isTimeout=a instanceof Ii&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof wd}
t(Mi,E);Mi.prototype.name="BiscottiError";function Ni(){E.call(this,"Biscotti ID is missing from server")}
t(Ni,E);Ni.prototype.name="BiscottiMissingError";var Hi={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Oi=null;function ce(){if("1"===Ua(ae(),"args","privembed"))return td(Error("Biscotti ID is not available in private embed mode"));Oi||(Oi=vd(Gi().then(Pi),function(a){return Qi(2,a)}));
return Oi}
...
function Ri(a,b){R(function(){vd(Gi().then(Pi,function(c){return Qi(b,c)}),xa)},a)}
function Si(){try{var a=z("yt.ads.biscotti.getId_");return a?a():ce()}catch(b){return td(b)}}
;function Ti(a){if("1"!==Ua(ae(),"args","privembed")){a&&be();try{Si().then(function(){},function(){}),R(Ti,18E5)}catch(b){P(b)}}}
;var Z=z("ytglobal.prefsUserPrefsPrefs_")||{};x("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Ui(){this.f=O("ALT_PREF_COOKIE_NAME","PREF");var a=Wb.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
ya(Ui);var Yi=null,Zi=null,$i=null,aj={};function bj(a){var b=a.id;a=a.ve_type;var c=zg++;a=new xg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});aj[b]=a;b=ih();c=hh();b&&c&&Qg(b,c,[a])}
function cj(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(jh(b,a),a=hh()))for(var c in aj){var d=aj[c];d&&Qg(b,a,[d])}}
function dj(a){aj[a.id]=new xg({trackingParams:a.tracking_params})}
function ej(a){var b=ih(),c=aj[a.id];if(b&&c){a=Rg;c={csn:b,ve:yg(c),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"};var d={ca:void 0,P:b};"UNDEFINED_CSN"==b?Sg("visualElementGestured",c,d):wg("visualElementGestured",c,a,d)}}
function fj(a){a=a.ids;var b=ih();if(b)for(var c=0;c<a.length;c++){var d=aj[a[c]];if(d){var e=Rg;d={csn:b,ve:yg(d),eventType:1};var f={ca:void 0,P:b};"UNDEFINED_CSN"==b?Sg("visualElementShown",d,f):wg("visualElementShown",d,e,f)}}}
;x("yt.setConfig",N,void 0);x("yt.config.set",N,void 0);x("yt.setMsg",Xe,void 0);x("yt.msgs.set",Xe,void 0);x("yt.logging.errors.log",Ve,void 0);
...
null):e.loadNewVideoConfig(a):(e=new sh(b,d,a,void 0),Hh[d]=e,jf("player-added",e.api),Tc(e,Ha(Jh,e)));a=e.api;Yi=a;a.addEventListener("onScreenChanged",cj);a.addEventListener("onLogClientVeCreated",bj);a.addEventListener("onLogServerVeCreated",dj);a.addEventListener("onLogVeClicked",ej);a.addEventListener("onLogVesShown",fj);var f=O("POST_MESSAGE_ID","player");O("ENABLE_JS_API")?$i=new Ei(a):O("ENABLE_POST_API")&&"string"===typeof f&&"string"===typeof c&&(Zi=new Fi(window.parent,f,c),$i=new zi(a,
Zi.h));c=O("BG_P",void 0);Lf(c)&&(O("BG_I")||O("BG_IU"))&&(Hf=!0,Gf.initialize(O("BG_I",null),O("BG_IU",null),c,Kf,void 0));Bf()},void 0);
x("yt.www.watch.ads.restrictioncookie.spr",function(a){Me(a+"mac_204?action_fcts=1");return!0},void 0);
var gj=ge(function(){var a=Rh(void 0),b;(b=!Q("use_first_tick"))||(b=!("ol"in Rh(void 0)));if(b&&(b="ol",X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b)),b=T(),a.ol=b,a=ni(),a.gelTicks&&(a.gelTicks.tick_ol=!0),T(),mi()?(bi().tick.ol=void 0,a=Uh(),fi().tick("ol",a,void 0),Vh(),a=!0):a=!1,!a)){if(!z("yt.timing.pingSent_")&&(b=O("TIMING_ACTION",void 0),a=Rh(void 0),z("ytglobal.timingready_")&&b&&a._start&&Qh())){Vh();b=!0;var c=O("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in
a)){b=!1;break}if(b&&!mi()){d=Rh(void 0);c=Th();e=d._start;var f=O("CSI_SERVICE_NAME","youtube");b={v:2,s:f,action:O("TIMING_ACTION",void 0)};a=c.srt;void 0!==d.srt&&delete c.srt;if(c.h5jse){var g=window.location.protocol+z("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:null)?c.h5jse=Math.round(c.h5jse-g.responseEnd):delete c.h5jse}d.aft=Qh();var h=Rh(void 0);g=h.pbr;var k=h.vc;h=h.pbs;if(g&&k&&h&&g<k&&k<h&&Th().yt_pvis&&"youtube"==f){Th().yt_lt="hot_bg";if(mi()){f="hot_bg";
g=ni();g.gelInfos?g.gelInfos.info_yt_lt=!0:(k={},g.gelInfos=(k.info_yt_lt=!0,k));if("yt_lt"in hi){g=hi.yt_lt;0<=Ka(ii,g)&&(f=!!f);"yt_lt"in ki&&"string"===typeof f&&(f=ki.yt_lt+f.toUpperCase());g=g.split(".");h=k={};for(var l=0;l<g.length-1;l++){var p=g[l];h[p]={};h=h[p]}h[g[g.length-1]]=f;f=Wh({},k)}else 0<=Ka(li,"yt_lt")||(f=new Qe("Unknown label logged with GEL CSI"),f.params={label:"yt_lt"},he(f)),f=void 0;f&&mi()&&(g=bi(),Wh(g.info,f),g=ni(),"gelInfos"in g||(g.gelInfos={}),Wh(g.gelInfos,f),g=
Uh(),fi().info(f,g))}else bi().info.yt_lt="hot_bg";f=d.vc;g=d.pbs;delete d.aft;c.aft=Math.round(g-f)}for(var n in c)"_"!=n.charAt(0)&&(b[n]=c[n]);d.ps=T();n={};f=[];for(var v in d)"_"!=v.charAt(0)&&(g=Math.round(d[v]-e),n[v]=g,f.push(v+"."+g));b.rt=f.join(",");(v=z("ytdebug.logTiming"))&&v(b,n);v=!!c.ap;Q("debug_csi_data")&&(c=z("yt.timing.csiData"),c||(c=[],Ia("yt.timing.csiData",c)),c.push({page:location.href,time:new Date,args:b}));c="";for(var q in b)b.hasOwnProperty(q)&&(c+="&"+q+"="+b[q]);q=
"/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&v){var y=void 0===y?"":y;Pe(q,y)||Me(q,void 0,void 0,void 0,y)}else Me(q);x("yt.timing.pingSent_",!0,void 0);Gg(Oh,new Mh(n.aft+(a||0),void 0))}}bi().tick.ol=void 0}y=Ui.getInstance();v=!!((Xi("f"+(Math.floor(119/31)+1))||0)&67108864);q=1<window.devicePixelRatio;document.body&&Yc(document.body,"exp-invert-logo")&&(q&&!Yc(document.body,"inverted-hdpi")?(n=document.body,n.classList?n.classList.add("inverted-hdpi"):Yc(n,"inverted-hdpi")||
(a=Wc(n),Xc(n,a+(0<a.length?" inverted-hdpi":"inverted-hdpi")))):!q&&Yc(document.body,"inverted-hdpi")&&Zc());v!=q&&(v="f"+(Math.floor(119/31)+1),n=Xi(v)||0,n=q?n|67108864:n&-67108865,0==n?delete Z[v]:(q=n.toString(16),Z[v]=q.toString()),y.save())}),hj=ge(function(){var a=Yi;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();O("PL_ATT")&&Gf.dispose();a=0;for(var b=zf.length;a<b;a++){var c=zf[a];if(!isNaN(c)){var d=z("yt.scheduler.instance.cancelJob");d?d(c):S(c)}}zf.length=0;tf("//static.doubleclick.net/instream/ad_status.js");Af=!1;N("DCLKSTAT",0);Vc($i,Zi);if(a=Yi)a.removeEventListener("onScreenChanged",cj),a.removeEventListener("onLogClientVeCreated",bj),a.removeEventListener("onLogServerVeCreated",dj),a.removeEventListener("onLogVeClicked",ej),a.removeEventListener("onLogVesShown",
fj),a.destroy();aj={}});
window.addEventListener?(window.addEventListener("load",gj),window.addEventListener("unload",hj)):window.attachEvent&&(window.attachEvent("onload",gj),window.attachEvent("onunload",hj));Ia("yt.abuse.player.botguardInitialized",z("yt.abuse.player.botguardInitialized")||Mf);Ia("yt.abuse.player.invokeBotguard",z("yt.abuse.player.invokeBotguard")||Nf);Ia("yt.abuse.dclkstatus.checkDclkStatus",z("yt.abuse.dclkstatus.checkDclkStatus")||Cf);
Ia("yt.player.exports.navigate",z("yt.player.exports.navigate")||kh);Ia("yt.util.activity.init",z("yt.util.activity.init")||Zf);Ia("yt.util.activity.getTimeSinceActive",z("yt.util.activity.getTimeSinceActive")||bg);Ia("yt.util.activity.setTimestamp",z("yt.util.activity.setTimestamp")||$f);}).call(this);
