...
$(document).ready(function(){
         ...
         $(document).ready(function(){
         	...
         	$('.mobile-menu-toggle-fixed-btn').click(function(){
         		$('.menu-image-tab').addClass('show');
         	})
			$('.menu-close-img').click(function(){
         		$('.menu-image-tab').removeClass('show');
         	})
         	$('.navbar-toggler, .mobile-menu-toggle-fixed-btn').click(function(){
         ...
         jQuery(window).scroll(function(){  var sticky = jQuery('.shadow-head-1, .basket-fixed-heading'),      scroll = jQuery(window).scrollTop();  if (scroll >= 450) sticky.addClass('fixed');  else sticky.removeClass('fixed');});
